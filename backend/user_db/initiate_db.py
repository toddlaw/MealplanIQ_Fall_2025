...
class DatabaseSchemaManager:
    ...
    def create_custom_recipes(self):
        cursor = self.db.cursor()
        drop_table_sql = "DROP TABLE IF EXISTS custom_recipes;"
        create_table_sql = """
        CREATE TABLE IF NOT EXISTS custom_recipes (
            ...
            betasitosterol_mg FLOAT,
            campesterol_mg FLOAT,
            stigmasterol_mg FLOAT,
            phytosterols_mg FLOAT,
            ...
            water_g FLOAT,
            protein_g FLOAT,
            protein_adjusted_g FLOAT,
            alanine_g FLOAT,
            arginine_g FLOAT,
            aspartic_acid_g FLOAT,
            betaine_g FLOAT,
            cystine_g FLOAT,
            glutamic_acid_g FLOAT,
            glycine_g FLOAT,
            histidine_g FLOAT,
            hydroxyproline_g FLOAT,
            isoleucine_g FLOAT,
            leucine_g FLOAT,
            lysine_g FLOAT,
            methionine_g FLOAT,
            ...
            ash_g FLOAT,
            vitamin_A_iu FLOAT,
            vitamin_A_RAE_g FLOAT,
            vitamin_A1_retinol_g FLOAT,
            thiamin_mg FLOAT,
            riboflavin_mg FLOAT,
            niacin_mg FLOAT,
            vitamin_B5_pantothenic_acid_mg FLOAT,
            vitamin_B6_mg FLOAT,
            vitamin_B12_added_ug FLOAT,
            vitamin_B12_ug FLOAT,
            folate_DFE_ug FLOAT,
            folate_food_ug FLOAT,
            folate_total_ug FLOAT,
            folic_acid_g FLOAT,
            vitamin_C_total_ascorbic_acid_mg FLOAT,
            vitiamin_D_IU FLOAT,
            vitamin_D2D3_ug FLOAT,
            vitamin_D2_ergocalciferol_g FLOAT,
            vitamin_E_alphatocopherol_mg FLOAT,
            vitamin_E_added_mg FLOAT,
            tocopherol_beta_mg FLOAT,
            tocopherol_delta_mg FLOAT,
            tocopherol_gamma_mg FLOAT,
            tocotrienol_alpha_mg FLOAT,
            tocotrienol_beta_mg FLOAT,
            tocotrienol_delta_mg FLOAT,
            tocotrienol_gamma_mg FLOAT,
            vitamin_K_phylloquinone_ug FLOAT,
            vitamin_K2_menaquinone4_g FLOAT,
            choline_mg FLOAT,
            carotene_alpha_g FLOAT,
            carotene_beta_g FLOAT,
            lutein_zeaxanthin_g FLOAT,
            lycophene_g FLOAT,
            fats_total_g FLOAT,
            fats_lipid_g FLOAT,
            fatty_acids_total_monounsaturated_g FLOAT,
            fatty_acids_total_polyunsaturated_g FLOAT,
            fatty_acids_total_saturated_g FLOAT,
            fatty_acids_total_polyunsaturated150_g FLOAT,
            fatty_acids_total_polyunsaturated161c_g FLOAT,
            fatty_acids_total_polyunsaturated161t_g FLOAT,
            fatty_acids_total_polyunsaturated170_g FLOAT,
            fatty_acids_total_polyunsaturated171_g FLOAT,
            fatty_acids_total_polyunsaturated181c_g FLOAT,
            fatty_acids_total_polyunsaturated182clas_g FLOAT,
            fatty_acids_total_polyunsaturated182i_g FLOAT,
            fatty_acids_total_polyunsaturated182n6cc_g FLOAT,
            fatty_acids_total_polyunsaturated182tnot_g FLOAT,
            fatty_acids_total_polyunsaturated182tt_g FLOAT,
            fatty_acids_total_polyunsaturated183n6ccc_g FLOAT,
            fatty_acids_total_polyunsaturated202n6cc_g FLOAT,
            fatty_acids_total_polyunsaturated203_g FLOAT,
            fatty_acids_total_polyunsaturated221c_g FLOAT,
            fatty_acids_total_polyunsaturated221t_g FLOAT,
            fatty_acids_total_polyunsaturated240_g FLOAT,
            fatty_acids_total_polyunsaturated241c_g FLOAT,
            fatty_acids_total_saturated100_g FLOAT,
            fatty_acids_total_saturated120n_g FLOAT,
            fatty_acids_total_saturated140_g FLOAT,
            fatty_acids_total_saturated141_g FLOAT,
            fatty_acids_total_saturated160_g FLOAT,
            fatty_acids_total_saturated161_g FLOAT,
            fatty_acids_total_saturated180_g FLOAT,
            fatty_acids_total_saturated181_g FLOAT,
            fatty_acids_total_saturated182_g FLOAT,
            fatty_acids_total_saturated183_g FLOAT,
            fatty_acids_total_saturated184 FLOAT,
            fatty_acids_total_saturated200_g FLOAT,
            fatty_acids_total_saturated201_g FLOAT,
            fatty_acids_total_saturated204_g FLOAT,
            fatty_acids_total_saturated205n3_g FLOAT,
            fatty_acids_total_saturated220_g FLOAT,
            fatty_acids_total_saturated221_g FLOAT,
            fatty_acids_total_saturated225n3dpa_g FLOAT,
            fatty_acids_total_saturated226n3dha_g FLOAT,
            fatty_acids_total_saturated40_g FLOAT,
            fatty_acids_total_saturated60_g FLOAT,
            fatty_acids_total_saturated80_g FLOAT,
            fatty_acids_total_trans_g FLOAT,
            fatty_acids_total_transmonoenoic_g FLOAT,
            fatty_acids_total_transpolyenoic_g FLOAT,
            fatty_acids_total_transpolyenoic130_g FLOAT,
            fatty_acids_total_transpolyenoic151_g FLOAT,
            fatty_acids_total_transpolyenoic18111_g FLOAT,
            fatty_acids_total_transpolyenoic183n3ccc_g FLOAT,
            fatty_acids_total_transpolyenoic183i_g FLOAT,
            fatty_acids_total_transpolyenoic203n3_g FLOAT,
            fatty_acids_total_transpolyenoic203n6 FLOAT,
            fatty_acids_total_transpolyenoic204n6_g FLOAT,
            fatty_acids_total_transpolyenoic215_g FLOAT,
            fatty_acids_total_transpolyenoic224_g FLOAT,
            alcohol_g FLOAT,
            caffeine_mg FLOAT,
            ...
            approximate_total_cost FLOAT,
            individual_ingredient_costs VARCHAR(255),
            ingredients_with_quantities VARCHAR(255),
            cooking_instructions VARCHAR(255),
            sports_build_muscle_score FLOAT,
            fight_heart_disease_score FLOAT,
            fight_diabetes_score FLOAT,
            fight_cancer_score FLOAT,
            lose_weight_score FLOAT,
            FOREIGN KEY (user_id) REFERENCES user_profile(user_id)
        );
        """
        try:
            ...
            self.db.rollback()
            print(f"Error creating custom_recipes table: {e}")
        finally:
            cursor.close()
